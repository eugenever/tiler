...
def mosaic_reader(  # noqa: C901
    ...
    **kwargs: Any,
    ...
    # create the threadpool only once
    with futures.ThreadPoolExecutor(max_workers=threads) as executor:
        for chunks in _chunks(mosaic_assets, chunk_size):
            tasks = create_tasks(reader, chunks, threads, executor, *args, **kwargs)
...
def mosaic_point_reader(
    ...
    *args: Any,
    ...
    chunk_size: Optional[int] = None,
    threads: int = MAX_THREADS,
    allowed_exceptions: Tuple[Any] = (PointOutsideBounds,),
    **kwargs: Any,
) -> Tuple[PointData, List[str]]:
    """Merge multiple assets.
